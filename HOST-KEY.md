...
> 🤫 **Host eyes only!** Pull this up in the GitHub app on your phone.
> The **#** beside each answer is the key you press (or slot you tap) on the
> game screen to reveal it. Answers are listed exactly in board order.
...
| # | Answer | Points |
|---|--------|-------:|
| **1** | Twinkle Twinkle Little Star | 32 |
| **2** | Rock-a-Bye Baby | 26 |
| **3** | Hush Little Baby | 18 |
| **4** | You Are My Sunshine | 12 |
| **5** | Brahms' Lullaby | 7 |
...
|---|--------|-------:|
| **1** | Rocking | 30 |
| **2** | Singing a Lullaby | 24 |
| **3** | Feeding a Bottle | 16 |
| **4** | Driving Around | 12 |
| **5** | White Noise | 10 |
| **6** | Pacifier | 8 |
...
| # | Answer | Points |
|---|--------|-------:|
| **1** | Carrying High or Low | 29 |
| **2** | Baby's Heart Rate | 22 |
| **3** | Sweet vs. Salty Cravings | 18 |
| **4** | Ring on a String | 14 |
...
*Regenerate this file after editing `js/questions.js` so the slot numbers stay in sync with the board.*
